...
type Handler struct {
	...
	// Resource settings for Init Container
	InitContainerCPULimit      resource.Quantity
	InitContainerCPURequest    resource.Quantity
	InitContainerMemoryLimit   resource.Quantity
