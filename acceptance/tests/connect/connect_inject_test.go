...
// TestConnectInject_NotSecure tests that Connect works in a default (non-secure) installation.
func TestConnectInject_NotSecure(t *testing.T) {
	cfg := suite.Config()
	if !cfg.EnableEnterprise {
		t.Skipf("skipping this test because -enable-enterprise is not set")
	}
	runConnectInject(t, false)
}

// TestConnectInject_Secure tests that Connect works in a secure (TLS+ACLs) installation.
func TestConnectInject_Secure(t *testing.T) {
	cfg := suite.Config()
	if !cfg.EnableEnterprise {
		t.Skipf("skipping this test because -enable-enterprise is not set")
	}
	runConnectInject(t, true)
}

func runConnectInject(t *testing.T, secure bool) {
	t.Helper()
	cfg := suite.Config()
...
// TestConnectInject_CleanupKilledPods_NotSecure tests that the endpoints controller
// cleans up force-killed pods in a non-secure installation.
func TestConnectInject_CleanupKilledPods_NotSecure(t *testing.T) {
	runConnectInjectCleanupKilledPods(t, false)
}

// TestConnectInject_CleanupKilledPods_Secure tests that the endpoints controller
// cleans up force-killed pods in a secure (TLS+ACLs) installation.
func TestConnectInject_CleanupKilledPods_Secure(t *testing.T) {
	runConnectInjectCleanupKilledPods(t, true)
}

func runConnectInjectCleanupKilledPods(t *testing.T, secure bool) {
	t.Helper()
	cfg := suite.Config()
...
// TestConnectInject_MultiportServices_NotSecure tests Connect with multi-port applications
// in a non-secure installation.
func TestConnectInject_MultiportServices_NotSecure(t *testing.T) {
	runConnectInjectMultiportServices(t, false)
}

// TestConnectInject_MultiportServices_Secure tests Connect with multi-port applications
// in a secure (TLS+ACLs) installation.
func TestConnectInject_MultiportServices_Secure(t *testing.T) {
	runConnectInjectMultiportServices(t, true)
}
...
func runConnectInjectMultiportServices(t *testing.T, secure bool) {
	t.Helper()
	cfg := suite.Config()
	cfg.SkipWhenOpenshiftAndCNI(t)
