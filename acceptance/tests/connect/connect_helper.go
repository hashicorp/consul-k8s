...
type ConnectHelper struct {
	...
	// HelmValues are the helm values to use when installing or upgrading the cluster.
	HelmValues map[string]string

	// IsSecure determines if the cluster is considered "secure" based on the Helm values configured.
	IsSecure bool
...
func (c *ConnectHelper) InstallThenCheckConnectInjection() {
	...
	c.consulClient = c.consulCluster.SetupConsulClient(c.T, c.IsSecure)
