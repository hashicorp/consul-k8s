...
type connectInjectNamespacesCase struct {
	destinationNamespace string
	mirrorK8S            bool
	secure               bool
}

// runConnectInjectNamespaces tests that Connect works with Consul Enterprise namespaces
// for a single combination of namespace mode and security setting.
func runConnectInjectNamespaces(t *testing.T, c connectInjectNamespacesCase) {
	t.Helper()
	cfg := suite.Config()
...
func TestConnectInjectNamespaces_SingleNamespace(t *testing.T) {
	runConnectInjectNamespaces(t, connectInjectNamespacesCase{destinationNamespace: staticServerNamespace, mirrorK8S: false, secure: false})
}

func TestConnectInjectNamespaces_SingleNamespaceSecure(t *testing.T) {
	runConnectInjectNamespaces(t, connectInjectNamespacesCase{destinationNamespace: staticServerNamespace, mirrorK8S: false, secure: true})
}

func TestConnectInjectNamespaces_MirroredNamespaces(t *testing.T) {
	runConnectInjectNamespaces(t, connectInjectNamespacesCase{destinationNamespace: staticServerNamespace, mirrorK8S: true, secure: false})
}

func TestConnectInjectNamespaces_MirroredNamespacesSecure(t *testing.T) {
	runConnectInjectNamespaces(t, connectInjectNamespacesCase{destinationNamespace: staticServerNamespace, mirrorK8S: true, secure: true})
}
