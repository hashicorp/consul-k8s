...
func TestAPIGateway_Lifecycle(t *testing.T) {
	...
	updateKubernetes(t, k8sClient, routeOne, func(r *gwv1.HTTPRoute) {
		r.Spec.ParentRefs[0].Name = gwv1.ObjectName(controlledGatewayTwoName)
	})
	...
	updateKubernetes(t, k8sClient, routeTwo, func(r *gwv1.HTTPRoute) {
		r.Spec.ParentRefs[0].Name = gwv1.ObjectName(uncontrolledGatewayName)
	})
	...
	updateKubernetes(t, k8sClient, routeOne, func(r *gwv1.HTTPRoute) {
		r.Spec.ParentRefs[0].Name = gwv1.ObjectName(controlledGatewayOneName)
	})
	...
	updateKubernetes(t, k8sClient, controlledGatewayOne, func(g *gwv1.Gateway) {
		g.Spec.GatewayClassName = gwv1.ObjectName(controlledGatewayClassOneName)
	})
			...
			Listeners: []gwv1.Listener{{
				...
				TLS: &gwv1.ListenerTLSConfig{
					CertificateRefs: []gwv1.SecretObjectReference{{
						Name: gwv1.ObjectName(certificate),
					}},
				},
			}},
		},
...
func createGatewayClass(t *testing.T, client client.Client, name, controllerName string, parameters *gwv1.ParametersReference) {
	t.Helper()
