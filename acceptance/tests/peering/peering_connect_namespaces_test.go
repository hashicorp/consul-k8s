...
type peeringConnectNamespacesCase struct {
	destinationNamespace string
	mirrorK8S            bool
	ACLsEnabled          bool
}

func runPeeringConnectNamespaces(t *testing.T, c peeringConnectNamespacesCase) {
	t.Helper()
...
func TestPeering_ConnectNamespaces_DefaultNamespace(t *testing.T) {
	runPeeringConnectNamespaces(t, peeringConnectNamespacesCase{destinationNamespace: "default", mirrorK8S: false, ACLsEnabled: false})
}

func TestPeering_ConnectNamespaces_SingleNamespace(t *testing.T) {
	runPeeringConnectNamespaces(t, peeringConnectNamespacesCase{destinationNamespace: staticServerNamespace, mirrorK8S: false, ACLsEnabled: false})
}

func TestPeering_ConnectNamespaces_MirroredNamespaces(t *testing.T) {
	runPeeringConnectNamespaces(t, peeringConnectNamespacesCase{destinationNamespace: staticServerNamespace, mirrorK8S: true, ACLsEnabled: false})
}

func TestPeering_ConnectNamespaces_DefaultNamespaceSecure(t *testing.T) {
	runPeeringConnectNamespaces(t, peeringConnectNamespacesCase{destinationNamespace: "default", mirrorK8S: false, ACLsEnabled: true})
}

func TestPeering_ConnectNamespaces_SingleNamespaceSecure(t *testing.T) {
	runPeeringConnectNamespaces(t, peeringConnectNamespacesCase{destinationNamespace: staticServerNamespace, mirrorK8S: false, ACLsEnabled: true})
}

func TestPeering_ConnectNamespaces_MirroredNamespacesSecure(t *testing.T) {
	runPeeringConnectNamespaces(t, peeringConnectNamespacesCase{destinationNamespace: staticServerNamespace, mirrorK8S: true, ACLsEnabled: true})
}
