...
func TestPartitions_Sync_DefaultNamespace(t *testing.T) {
	runPartitionsSync(t, partitionsSyncCase{destinationNamespace: defaultNamespace, mirrorK8S: false, ACLsEnabled: false})
}

func TestPartitions_Sync_DefaultNamespaceACLs(t *testing.T) {
	runPartitionsSync(t, partitionsSyncCase{destinationNamespace: defaultNamespace, mirrorK8S: false, ACLsEnabled: true})
}

func TestPartitions_Sync_SingleNamespace(t *testing.T) {
	runPartitionsSync(t, partitionsSyncCase{destinationNamespace: staticServerNamespace, mirrorK8S: false, ACLsEnabled: false})
}

func TestPartitions_Sync_SingleNamespaceACLs(t *testing.T) {
	runPartitionsSync(t, partitionsSyncCase{destinationNamespace: staticServerNamespace, mirrorK8S: false, ACLsEnabled: true})
}

func TestPartitions_Sync_MirrorK8S(t *testing.T) {
	runPartitionsSync(t, partitionsSyncCase{destinationNamespace: staticServerNamespace, mirrorK8S: true, ACLsEnabled: false})
}

func TestPartitions_Sync_MirrorK8SACLs(t *testing.T) {
	runPartitionsSync(t, partitionsSyncCase{destinationNamespace: staticServerNamespace, mirrorK8S: true, ACLsEnabled: true})
}
