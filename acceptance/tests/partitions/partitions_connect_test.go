			...
			t.Run("in-partition", func(t *testing.T) {
				...
				if cfg.EnableTransparentProxy {
					...
					if c.destinationNamespace == defaultNamespace {
						if cfg.EnableWindows {
							k8s.DeployKustomize(t, defaultPartitionClusterStaticClientOpts, cfg.NoCleanupOnFailure, cfg.DebugDirectory, "../fixtures/cases/static-client-inject-windows")
						} else {
						...
						if cfg.EnableWindows {
							k8s.DeployKustomize(t, defaultPartitionClusterStaticClientOpts, cfg.NoCleanupOnFailure, cfg.DebugDirectory, "../fixtures/cases/static-client-namespaces-windows")
						} else {
				...
				if cfg.EnableTransparentProxy {
					...
					if c.destinationNamespace == defaultNamespace {
						if cfg.EnableWindows {
							k8s.DeployKustomize(t, secondaryPartitionClusterStaticClientOpts, cfg.NoCleanupOnFailure, cfg.DebugDirectory, "../fixtures/cases/static-client-inject-windows")
						} else {
						...
						if cfg.EnableWindows {
							k8s.DeployKustomize(t, secondaryPartitionClusterStaticClientOpts, cfg.NoCleanupOnFailure, cfg.DebugDirectory, "../fixtures/cases/static-client-namespace-windows")
						} else {
