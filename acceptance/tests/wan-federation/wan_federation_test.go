...
type wanFederationCase struct {
	secure bool
}

func runWANFederation(t *testing.T, c wanFederationCase) {
	t.Helper()
...
func TestWANFederation_Secure(t *testing.T)    { runWANFederation(t, wanFederationCase{secure: true}) }
...
func TestWANFederationFailover_Secure(t *testing.T) {
	runWANFederationFailover(t, wanFederationCase{secure: true})
}
func TestWANFederationFailover_NotSecure(t *testing.T) {
	runWANFederationFailover(t, wanFederationCase{secure: false})
}
