...
func (t *TestConfig) HelmValuesFromConfig() (map[string]string, error) {
	...
	if t.EnableWindows {
		setIfNotEmpty(helmValues, "global.apiGateway.controller.nodeSelector.kubernetes.io/os", "linux")
		setIfNotEmpty(helmValues, "global.apiGateway.managedGatewayClass.nodeSelector.kubernetes.io/os", "linux")
		...
		setIfNotEmpty(helmValues, "global.meshGateway.nodeSelector.kubernetes.io/os", "linux")
