...
// const (
// 	StaticClientName = "test-job"
// 	StaticServerName = "static-server"
// )

// // ConnectHelperJob configures a Consul cluster for connect injection tests.
// // It also provides helper methods to exercise the connect functionality.
// type ConnectHelperJob struct {
...
// func (c *ConnectHelperJob) Setup(t *testing.T) {
...
// func (c *ConnectHelperJob) Install(t *testing.T) {
...
// func (c *ConnectHelperJob) Upgrade(t *testing.T) {
...
// func (c *ConnectHelperJob) DeployJobAndServer(t *testing.T) {
...
// func (c *ConnectHelperJob) TestConnectionFailureWithoutIntention(t *testing.T) {
...
// func (c *ConnectHelperJob) CreateIntention(t *testing.T) {
...
// func (c *ConnectHelperJob) TestConnectionSuccess(t *testing.T) {
...
// // after this check.
// func (c *ConnectHelperJob) TestConnectionFailureWhenUnhealthy(t *testing.T) {
...
// func (c *ConnectHelperJob) helmValues() map[string]string {
// 	helmValues := map[string]string{
