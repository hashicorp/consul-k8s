...
require (
	...
	github.com/hashicorp/consul-k8s/control-plane/cni v0.0.0-20230825213844-4ea04860c5ed // indirect
	github.com/hashicorp/consul-server-connection-manager v0.1.6 // indirect
