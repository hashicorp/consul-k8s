...
require (
	...
	github.com/hashicorp/consul/troubleshoot v0.5.3
...
require (
	...
	github.com/hashicorp/consul/api v1.27.1 // indirect
	github.com/hashicorp/consul/envoyextensions v0.5.3 // indirect
