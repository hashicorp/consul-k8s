...
func (c *ListCommand) fetchPods() ([]v1.Pod, error) {
	...
	proxySelectors := []struct {
		...
		{Target: apiGateways, Selector: "component=api-gateway-custom, gateway.consul.hashicorp.com/managed=true"},
		{Target: apiGateways, Selector: "api-gateway-custom.consul.hashicorp.com/managed=true"},
