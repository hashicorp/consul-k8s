...
* [Experimental] Cluster Peering:
  ...
  * Add support for Load Balancers or external addresses in front of Consul servers for peering stream.
    ...
    * Support arbitrary addresses as the server addresses in the peering token via `global.peering.tokenGeneration.source="static"` and `global.peering.tokenGeneration.static=["sample-server-address:8503"]`. [[GH-1392](https://github.com/hashicorp/consul-k8s/pull/1392)]
