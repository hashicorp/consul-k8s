...
// "true" it returns a config with Enabled=true; otherwise it returns the zero
// value.
...
func (t ResourceTranslator) translateGatewayPolicy(policy *v1alpha1.CustomGatewayPolicy) (*api.APIGatewayPolicy, *api.APIGatewayPolicy) {
	if policy == nil {
		return nil, nil
	}
