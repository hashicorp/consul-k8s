...
type ResourceMap struct {
	...
	gatewayPolicies       map[api.ResourceReference]*v1alpha1.CustomGatewayPolicy
...
func NewResourceMap(translator ResourceTranslator, validator ReferenceValidator, logger logr.Logger) *ResourceMap {
	return &ResourceMap{
		...
		gatewayPolicies:       make(map[api.ResourceReference]*v1alpha1.CustomGatewayPolicy),
...
func (s *ResourceMap) AddGatewayPolicy(gatewayPolicy *v1alpha1.CustomGatewayPolicy) *v1alpha1.CustomGatewayPolicy {
	sectionName := ""
	...
	if s.gatewayPolicies == nil {
		s.gatewayPolicies = make(map[api.ResourceReference]*v1alpha1.CustomGatewayPolicy)
	}
...
func (s *ResourceMap) GetJWTProviderForGatewayJWTProvider(provider *v1alpha1.CustomGatewayJWTProvider) (*v1alpha1.JWTProvider, bool) {
	key := api.ResourceReference{
		Name: provider.Name,
		Kind: "JWTProvider",
	}
...
func (s *ResourceMap) GetPolicyForGatewayListener(gateway gwv1beta1.Gateway, gatewayListener gwv1beta1.Listener) (*v1alpha1.CustomGatewayPolicy, bool) {
	key := api.ResourceReference{
		Name:        gateway.Name,
		Kind:        gateway.Kind,
