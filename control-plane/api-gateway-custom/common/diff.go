...
func GatewayPolicyStatusesEqual(a, b v1alpha1.CustomGatewayPolicyStatus) bool {
...
func (e entryComparator) apiGatewaysEqual(a, b api.APIGatewayConfigEntry) bool {
	return a.Kind == b.Kind &&
		...
		apiGatewayExtAuthzEqual(a.ExtAuthz, b.ExtAuthz)
}

func apiGatewayExtAuthzEqual(a, b *api.APIGatewayExtAuthz) bool {
	if a == nil && b == nil {
		return true
	}
	if a == nil || b == nil {
