...
func validateGatewayPolicies(gateway gwv1beta1.Gateway, policies []v1alpha1.CustomGatewayPolicy, resources *common.ResourceMap) gatewayPolicyValidationResults {
...
func listenerExistsForPolicy(gateway gwv1beta1.Gateway, policy v1alpha1.CustomGatewayPolicy) bool {
