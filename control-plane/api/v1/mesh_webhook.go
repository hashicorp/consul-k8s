...
//
// +kubebuilder:webhook:verbs=create;update,path=/mutate-v1-mesh,mutating=true,failurePolicy=fail,groups=consul.hashicorp.com,resources=mesh,versions=v1,name=mutate-mesh.consul.hashicorp.com,sideEffects=None,admissionReviewVersions=v1beta1;v1
