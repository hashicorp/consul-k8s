...
//
// +kubebuilder:webhook:verbs=create;update,path=/mutate-v1-exportedservices,mutating=true,failurePolicy=fail,groups=consul.hashicorp.com,resources=exportedservices,versions=v1,name=mutate-exportedservices.consul.hashicorp.com,sideEffects=None,admissionReviewVersions=v1beta1;v1
...
func (v *ExportedServicesWebhook) InjectDecoder(d *admission.Decoder) error {
	v.decoder = d
	return nil
}
