...
func TestServiceIntentions_Validate(t *testing.T) {
	cases := map[string]struct {
		...
		"single source peer and partition specified": {
			...
			partitionsEnabled: true,
			expectedErrMsgs: []string{
				`spec.sources[0]: Invalid value: v1.SourceIntention{Name:"web", Namespace:"namespace-b", Peer:"peer-other", Partition:"partition-other", Action:"allow", Permissions:v1.IntentionPermissions(nil), Description:""}: Both source.peer and source.partition cannot be set.`,
			},
		},
		"multiple source peer and partition specified": {
			...
			expectedErrMsgs: []string{
				`spec.sources[0]: Invalid value: v1.SourceIntention{Name:"web", Namespace:"namespace-b", Peer:"peer-other", Partition:"partition-other", Action:"allow", Permissions:v1.IntentionPermissions(nil), Description:""}: Both source.peer and source.partition cannot be set.`,
				`spec.sources[1]: Invalid value: v1.SourceIntention{Name:"db", Namespace:"namespace-c", Peer:"peer-2", Partition:"partition-2", Action:"deny", Permissions:v1.IntentionPermissions(nil), Description:""}: Both source.peer and source.partition cannot be set.`,
			},
		},
	}
