...
//
// +kubebuilder:webhook:verbs=create;update,path=/mutate-v1-terminatinggateway,mutating=true,failurePolicy=fail,groups=consul.hashicorp.com,resources=terminatinggateways,versions=v1,name=mutate-terminatinggateway.consul.hashicorp.com,sideEffects=None,admissionReviewVersions=v1beta1;v1
...
func (v *TerminatingGatewayWebhook) List(ctx context.Context) ([]common.ConfigEntryResource, error) {
	var resourceList TerminatingGatewayList
