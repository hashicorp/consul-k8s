...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in JSONRawObject) DeepCopyInto(out *JSONRawObject) {
	{
		in := &in
		*out = make(JSONRawObject, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JSONRawObject.
func (in JSONRawObject) DeepCopy() JSONRawObject {
	if in == nil {
		return nil
	}
	out := new(JSONRawObject)
	in.DeepCopyInto(out)
	return *out
}
