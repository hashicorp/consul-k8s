...
//
// +kubebuilder:webhook:verbs=create;update,path=/mutate-v2beta1-proxyconfiguration,mutating=true,failurePolicy=fail,groups=mesh.consul.hashicorp.com,resources=proxyconfiguration,versions=v2beta1,name=mutate-proxyconfiguration.mesh.consul.hashicorp.com,sideEffects=None,admissionReviewVersions=v1beta1;v1
