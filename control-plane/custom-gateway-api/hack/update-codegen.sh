...
ln -s "${SCRIPT_ROOT}" "$GOPATH/src/github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api"

readonly OUTPUT_PKG=github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api/pkg/client
readonly APIS_PKG=github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api
