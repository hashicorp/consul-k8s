...
import (
	...
	gatewayv1a2 "github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api/apis/v1alpha2"
	gatewayv1b1validation "github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api/apis/v1beta1/validation"
)
...
//
//	https://gateway-api.sigs.k8s.io/v1alpha2/references/spec/#consul.networking.io/v1alpha2.Gateway
//
