...
import (
	...
	v1a2 "github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api/apis/v1alpha2"
	gatewayvalidationv1b1 "github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api/apis/v1beta1/validation"
)
