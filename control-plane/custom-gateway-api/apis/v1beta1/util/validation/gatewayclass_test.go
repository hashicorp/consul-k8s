...
import (
	...
	gatewayv1b1 "github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api/apis/v1beta1"
	validationtutils "github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api/apis/v1beta1/util/validation"
)
