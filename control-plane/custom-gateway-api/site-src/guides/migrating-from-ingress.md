...
* *External references.* A feature (field) of a Gateway API resource can
  ...
  configures that feature. For example:
    * [HTTPRouteFilter](/references/spec/#consul.networking.io/v1beta1.HTTPRouteFilter)
      can reference an external resource via the `extensionRef` field, thus
      configuring an implementation-specific filter.
    * [BackendObjectReference](/references/spec/#consul.networking.io/v1beta1.BackendObjectReference)
      supports resources other than Services.
    * [SecretObjectReference](/references/spec/#consul.networking.io/v1beta1.SecretObjectReference)
...
* *Custom implementations*. For some features, it is left up to an
  ...
  example:
    * The `RegularExpression` type of
      the [HTTPPathMatch](/references/spec/#consul.networking.io/v1beta1.HTTPPathMatch).
...
a [listener](/references/spec/#consul.networking.io/v1beta1.Listener) for
...
the [Gateway listener](/references/spec/#consul.networking.io/v1beta1.Listener),
...
the [routing rules](/references/spec/#consul.networking.io/v1beta1.HTTPRouteRule)
...
map to
the [hostnames](/references/spec/#consul.networking.io/v1beta1.Hostname) of
...
> The `hostnames` of an HTTPRoute must match the `hostname` of the [Gateway listener](/references/spec/#consul.networking.io/v1beta1.Listener).
> Otherwise, the listener will ignore the routing rules for the unmatched
> hostnames. See the [HTTPRoute documentation](/references/spec/#consul.networking.io/v1beta1.HTTPRouteSpec).
...
a [parentRef](/references/spec/#consul.networking.io/v1beta1.ParentRef).
