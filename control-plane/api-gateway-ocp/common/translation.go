...
func (t ResourceTranslator) translateRouteJWTFilter(routeJWTFilter *v1alpha1.RouteAuthFilter) *api.JWTFilter {
	...
	return &api.JWTFilter{
		Providers: ConvertSliceFunc(routeJWTFilter.Spec.JWTOCP.Providers, t.translateJWTProvider),
	}
}
...
func (t ResourceTranslator) translateJWTRequirement(crdRequirement *v1alpha1.OcpGatewayJWTRequirement) *api.APIGatewayJWTRequirement {
...
func (t ResourceTranslator) translateJWTProvider(crdProvider *v1alpha1.OcpGatewayJWTProvider) *api.APIGatewayJWTProvider {
	if crdProvider == nil {
		return nil
	}
...
func (t ResourceTranslator) translateVerifyClaims(crdClaims *v1alpha1.OcpGatewayJWTClaimVerification) *api.APIGatewayJWTClaimVerification {
	if crdClaims == nil {
		return nil
	}
