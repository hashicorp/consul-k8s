...
func (t ResourceTranslator) ToAPIGateway(gateway gwv1alpha2.Gateway, resources *ResourceMap, gwcc *v1alpha1.GatewayClassConfig) *api.APIGatewayConfigEntry {
	namespace := t.Namespace(gateway.Namespace)

	listeners := ConvertSliceFuncIf(gateway.Spec.Listeners, func(listener gwv1alpha2.Listener) (api.APIGatewayListener, bool) {
...
func (t ResourceTranslator) toAPIGatewayListener(gateway gwv1alpha2.Gateway, listener gwv1alpha2.Listener, resources *ResourceMap, gwcc *v1alpha1.GatewayClassConfig) (api.APIGatewayListener, bool) {
...
func ToContainerPort(portNumber gwv1alpha2.PortNumber, mapPrivilegedContainerPorts int32) int {
	if portNumber >= 1024 {
...
func (t ResourceTranslator) ToHTTPRoute(route gwv1alpha2.HTTPRoute, resources *ResourceMap) *api.HTTPRouteConfigEntry {
	...
	rules := ConvertSliceFuncIf(
		route.Spec.Rules,
		func(rule gwv1alpha2.HTTPRouteRule) (api.HTTPRouteRule, bool) {
...
func (t ResourceTranslator) translateHTTPRouteRule(route gwv1alpha2.HTTPRoute, rule gwv1alpha2.HTTPRouteRule, resources *ResourceMap) (api.HTTPRouteRule, bool) {
	services := ConvertSliceFuncIf(
		rule.BackendRefs,
		func(ref gwv1alpha2.HTTPBackendRef) (api.HTTPService, bool) {
...
func (t ResourceTranslator) translateHTTPBackendRef(route gwv1alpha2.HTTPRoute, ref gwv1alpha2.HTTPBackendRef, resources *ResourceMap) (api.HTTPService, bool) {
...
var headerMatchTypeTranslation = map[gwv1alpha2.HeaderMatchType]api.HTTPHeaderMatchType{
	gwv1alpha2.HeaderMatchExact:             api.HTTPHeaderMatchExact,
	gwv1alpha2.HeaderMatchRegularExpression: api.HTTPHeaderMatchRegularExpression,
}

var headerPathMatchTypeTranslation = map[gwv1alpha2.PathMatchType]api.HTTPPathMatchType{
	gwv1alpha2.PathMatchExact:             api.HTTPPathMatchExact,
	gwv1alpha2.PathMatchPathPrefix:        api.HTTPPathMatchPrefix,
	gwv1alpha2.PathMatchRegularExpression: api.HTTPPathMatchRegularExpression,
}

var queryMatchTypeTranslation = map[gwv1alpha2.QueryParamMatchType]api.HTTPQueryMatchType{
	gwv1alpha2.QueryParamMatchExact:             api.HTTPQueryMatchExact,
	gwv1alpha2.QueryParamMatchRegularExpression: api.HTTPQueryMatchRegularExpression,
}

func (t ResourceTranslator) translateHTTPMatch(match gwv1alpha2.HTTPRouteMatch) api.HTTPMatch {
...
func (t ResourceTranslator) translateHTTPPathMatch(match gwv1alpha2.HTTPPathMatch) api.HTTPPathMatch {
...
func (t ResourceTranslator) translateHTTPHeaderMatch(match gwv1alpha2.HTTPHeaderMatch) api.HTTPHeaderMatch {
...
func (t ResourceTranslator) translateHTTPQueryMatch(match gwv1alpha2.HTTPQueryParamMatch) api.HTTPQueryMatch {
...
func (t ResourceTranslator) translateHTTPFilters(filters []gwv1alpha2.HTTPRouteFilter, resourceMap *ResourceMap, namespace string) (api.HTTPFilters, api.HTTPResponseFilters) {
	var (
...
// 	backendRefs := ConvertSliceFunc(route.Spec.Rules, func(rule gwv1alpha2.TCPRouteRule) []gwv1alpha2.BackendRef { return rule.BackendRefs })
// 	flattenedRefs := Flatten(backendRefs)
// 	services := ConvertSliceFuncIf(flattenedRefs, func(ref gwv1alpha2.BackendRef) (api.TCPService, bool) {
...
// func (t ResourceTranslator) translateTCPRouteRule(route gwv1alpha2.TCPRoute, ref gwv1alpha2.BackendRef, resources *ResourceMap) (api.TCPService, bool) {
