...
func gatewayMetricsEnabled(gateway gwv1.Gateway, gcc v1alpha1.GatewayClassConfig, config HelmConfig) bool {
...
func fetchPortString(gateway gwv1.Gateway, gcc v1alpha1.GatewayClassConfig, config HelmConfig) string {
	// first check our annotations, if something is there, then it means we've explicitly
	// annotated metrics collection
...
func gatewayMetricsPort(gateway gwv1.Gateway, gcc v1alpha1.GatewayClassConfig, config HelmConfig) int {
...
func gatewayMetricsPath(gateway gwv1.Gateway, gcc v1alpha1.GatewayClassConfig, config HelmConfig) string {
	// first check our annotations, if something is there, then it means we've explicitly
	// annotated metrics collection
...
func GatewayMetricsConfig(gateway gwv1.Gateway, gcc v1alpha1.GatewayClassConfig, config HelmConfig) MetricsConfig {
