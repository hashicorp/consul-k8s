...
func FilterIsExternalFilter(filter gwv1.HTTPRouteFilter) bool {
	...
	case v1alpha1.RouteRetryFilterKind, v1alpha1.RouteTimeoutFilterKind, v1alpha1.RouteAuthFilterKind, v1alpha1.RouteTLSSDSFilterKind, v1alpha1.RouteUpstreamLimitsFilterKind:
		return true
	}
