...
func TestRun_FlagValidation(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			expErr: "-consul-k8s-image-windows must be set",
		},
		{
			flags:  []string{"-consul-k8s-image", "foo", "-consul-k8s-image-windows", "foo"},
			expErr: "-consul-image must be set",
		},
		{
			flags:  []string{"-consul-k8s-image", "foo", "-consul-k8s-image-windows", "foo", "-consul-image", "foo"},
			expErr: "-consul-image-windows must be set",
		},
		{
			flags:  []string{"-consul-k8s-image", "foo", "-consul-k8s-image-windows", "foo", "-consul-image", "foo", "-consul-image-windows", "foo"},
			expErr: "-consul-dataplane-image must be set",
		},
		{
			flags:  []string{"-consul-k8s-image", "foo", "-consul-k8s-image-windows", "foo", "-consul-image", "foo", "-consul-image-windows", "foo", "-consul-dataplane-image", "consul-dataplane:1.14.0"},
			expErr: "-consul-dataplane-image-windows must be set",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-k8s-image-windows", "foo", "-consul-image", "foo", "-consul-image-windows", "foo", "-consul-dataplane-image", "consul-dataplane:1.14.0", "-consul-dataplane-image-windows", "consul-dataplane-windows:1.14.0",
				"-log-level", "invalid"},
