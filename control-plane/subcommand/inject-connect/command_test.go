...
func TestRun_FlagValidation(t *testing.T) {
	cases := []struct {
		...
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-enable-central-config", "true"},
			expErr: "-enable-central-config is no longer supported",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-protocol", "http"},
			expErr: "-default-protocol is no longer supported",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-ca-file", "bar"},
			expErr: "error reading Consul's CA cert file \"bar\"",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-enable-partitions", "true"},
			expErr: "-partition-name must set if -enable-partitions is set to 'true'",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-partition", "default"},
			expErr: "-enable-partitions must be set to 'true' if -partition-name is set",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-sidecar-proxy-cpu-limit=unparseable"},
			expErr: "-default-sidecar-proxy-cpu-limit is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-sidecar-proxy-cpu-request=unparseable"},
			expErr: "-default-sidecar-proxy-cpu-request is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-sidecar-proxy-memory-limit=unparseable"},
			expErr: "-default-sidecar-proxy-memory-limit is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-sidecar-proxy-memory-request=unparseable"},
		...
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-init-container-cpu-limit=unparseable"},
			expErr: "-init-container-cpu-limit 'unparseable' is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-init-container-cpu-request=unparseable"},
			expErr: "-init-container-cpu-request 'unparseable' is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-init-container-memory-limit=unparseable"},
			expErr: "-init-container-memory-limit 'unparseable' is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-init-container-memory-request=unparseable"},
			expErr: "-init-container-memory-request 'unparseable' is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-init-container-memory-request=50Mi",
		...
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-init-container-cpu-request=50m",
		...
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-consul-sidecar-cpu-limit=unparseable"},
			expErr: "-default-consul-sidecar-cpu-limit 'unparseable' is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-consul-sidecar-cpu-request=unparseable"},
			expErr: "-default-consul-sidecar-cpu-request 'unparseable' is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-consul-sidecar-memory-limit=unparseable"},
			expErr: "-default-consul-sidecar-memory-limit 'unparseable' is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-consul-sidecar-memory-request=unparseable"},
			expErr: "-default-consul-sidecar-memory-request 'unparseable' is invalid",
		},
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-consul-sidecar-memory-request=50Mi",
		...
		{
			flags: []string{"-consul-k8s-image", "foo", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-default-consul-sidecar-cpu-request=50m",
		...
		},
		{
			flags: []string{"-consul-k8s-image", "hashicorp/consul-k8s", "-consul-image", "foo", "-envoy-image", "envoy:1.16.0",
				"-consul-api-timeout", "5", "-http-addr=http://0.0.0.0:9999",
				"-listen", "999999"},
