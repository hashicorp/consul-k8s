...
func (c *Command) init() {
	...
	c.flagSet.StringVar(&c.flagConsulOBOInboundImage, "consul-obo-inbound-image", "",
		"Docker image for consul-obo-inbound. INBOUND OBO sidecar injected into ai-agent pods.")
	c.flagSet.StringVar(&c.flagConsulOBOOutboundImage, "consul-obo-outbound-image", "",
		"Docker image for consul-obo-outbound. OUTBOUND OBO sidecar injected into ai-agent pods.")
