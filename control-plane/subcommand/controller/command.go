...
import (
	...
	webhook2 "github.com/hashicorp/consul-k8s/control-plane/connect-inject/webhook"
...
func (c *Command) Run(args []string) int {
	...
	if err = mgr.AddReadyzCheck("ready", webhook2.ReadinessCheck{CertDir: c.flagWebhookTLSCertDir}.Ready); err != nil {
