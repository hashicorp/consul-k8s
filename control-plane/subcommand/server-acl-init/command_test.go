...
// when the injector deployment is created or when ACLs are enabled as it
// is also used by the consul-k8s-component-auth-method.
// It returns the Service Account CA Cert and JWT token.
