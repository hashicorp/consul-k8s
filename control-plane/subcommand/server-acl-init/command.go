...
func (c *Command) init() {
	...
	c.flags.BoolVar(&c.flagSyncCatalog, "sync-catalog", false,
		"Toggle for creating acl policies and rolebindings for sync catalog.")
	...
	c.flags.BoolVar(&c.flagConnectInject, "connect-inject", false,
		"Toggle for creating acl policies and rolebindings for Connect inject.")
	...
	c.flags.BoolVar(&c.flagSnapshotAgent, "snapshot-agent", false,
		"[Enterprise Only] Toggle for creating acl policies and rolebindings for the snapshot agent.")
	c.flags.BoolVar(&c.flagMeshGateway, "mesh-gateway", false,
		"Toggle for creating acl policies and rolebindings for the mesh gateway.")
	...
	c.flags.BoolVar(&c.flagAPIGatewayController, "api-gateway-controller", false,
		"Toggle for creating acl policies and rolebindings for the API gateway controller.")
