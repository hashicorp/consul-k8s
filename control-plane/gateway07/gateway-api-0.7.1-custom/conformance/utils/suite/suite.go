...
import (
	...
	"github.com/hashicorp/consul-k8s/control-plane/gateway07/gateway-api-0.7.1-custom/conformance"
	"github.com/hashicorp/consul-k8s/control-plane/gateway07/gateway-api-0.7.1-custom/conformance/utils/config"
...
func (suite *ConformanceTestSuite) Setup(t *testing.T) {
	...
	suite.Applier.CustomGatewayClass = suite.GatewayClassName
