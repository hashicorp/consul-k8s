			...
			expectedConsulSvcInstances: []*api.CatalogService{
				{
					...
					ServiceMeta:    map[string]string{MetaKeyPodName: "pod1", MetaKeyKubeServiceName: "service-created", MetaKeyKubeNS: test.SourceKubeNS, MetaKeyManagedBy: managedByValue, MetaKeyPodUID: ""},
					ServiceTags:    []string{},
				...
				},
				{
					...
					ServiceMeta:    map[string]string{MetaKeyPodName: "pod2", MetaKeyKubeServiceName: "service-created", MetaKeyKubeNS: test.SourceKubeNS, MetaKeyManagedBy: managedByValue, MetaKeyPodUID: ""},
					ServiceTags:    []string{},
					Namespace:      test.ExpConsulNS,
				},
			},
