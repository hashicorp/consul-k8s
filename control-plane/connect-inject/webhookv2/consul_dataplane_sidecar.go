...
func (w *MeshWebhook) consulDataplaneSidecar(namespace corev1.Namespace, pod corev1.Pod) (corev1.Container, error) {
	...
	args, err := w.getContainerSidecarArgs(namespace, bearerTokenFile, pod)
	if err != nil {
		return corev1.Container{}, err
	}
