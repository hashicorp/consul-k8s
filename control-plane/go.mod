...
replace github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api => ./custom-gateway-api
...
require (
	...
	github.com/hashicorp/consul-k8s/control-plane/custom-gateway-api v0.0.0
