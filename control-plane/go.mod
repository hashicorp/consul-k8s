...
// replace "sigs.k8s.io/gateway-api/apis/v1alpha2/exp" => ./gateway07/gateway-api-0.7.1-exp/apis/v1alpha2

// replace "sigs.k8s.io/gateway-api/apis/v1beta1/exp" => ./gateway07/gateway-api-0.7.1-exp/apis/v1beta1

// replace "sigs.k8s.io/gateway-api/apis/v1alpha3/exp" => ./gateway07/gateway-api-0.7.1-exp/apis/v1alpha3
