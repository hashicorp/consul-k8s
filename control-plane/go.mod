...
replace github.com/hashicorp/consul/api => github.com/hashicorp/consul/api v1.34.0

replace github.com/hashicorp/consul/sdk => github.com/hashicorp/consul/sdk v0.18.0
